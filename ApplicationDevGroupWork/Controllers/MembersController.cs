...
namespace ApplicationDevGroupWork.Controllers
{
    public class MembersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MemberId,Name,Address,Email,Phone,DateOfBirth,MemberCategoryId")] Member member)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MemberId,Name,Address,Email,Phone,DateOfBirth,MemberCategoryId")] Member member)
        {
            if (ModelState.IsValid)
            {
