...
namespace ApplicationDevGroupWork.Controllers
{
    public class ProducersController : Controller
    {
        ...
        {
            var producers = db.Producers.Include(p => p.DVDDetails);
        ...
        public ActionResult Create([Bind(Include = "ProducerId,Name,Address,Studio_name,Email,Gender,DVDDetailsId")] Producer producer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProducerId,Name,Address,Studio_name,Email,Gender,DVDDetailsId")] Producer producer)
        {
            if (ModelState.IsValid)
            {
