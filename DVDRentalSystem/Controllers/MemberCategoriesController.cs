...
namespace DVDRentalSystem.Controllers
{
    public class MemberCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MemberCategoryId,FirstName,LastName,Description,TotalLoan")] MemberCategory memberCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MemberCategoryId,FirstName,LastName,Description,TotalLoan")] MemberCategory memberCategory)
        {
            if (ModelState.IsValid)
            {
