...
namespace DVDRentalSystem.Controllers
{
    public class MembersController : Controller
    {
        ...
        {
            var members = db.Members.Include(m => m.MemberCategory);
        ...
        public ActionResult Create([Bind(Include = "MemberId,FirstName,LastName,Address,Email,Phone,DateOfBirth,MemberCategoryId")] Member member)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MemberId,FirstName,LastName,Address,Email,Phone,DateOfBirth,MemberCategoryId")] Member member)
        {
            if (ModelState.IsValid)
            {
