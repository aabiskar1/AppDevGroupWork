...
namespace DVDRentalSystem.Controllers
{
    public class LoansController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LoanId,DVDDetailsId,IssueDate,ReturnDate,FineAmount,MemberId,returned")] Loan loan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LoanId,DVDDetailsId,IssueDate,ReturnDate,FineAmount,MemberId,returned")] Loan loan)
        {
            if (ModelState.IsValid)
            {
